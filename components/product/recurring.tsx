...
import { api, Field, Busy, Modal, Confirm } from "./common";
...
const cards = [
  {
    ...
    name: "Neta Standart",
    features: [
      "Web randevuları ve takvim",
      "Hizmet ve ekip yönetimi",
      "Müşteri geçmişi",
      "AI yardım: günde 10 soru",
      "WhatsApp: ayda 100 mesaj",
    ],
  },
  {
    code: "pro",
    ...
    features: [
      ...
      "Veresiye ve hizmet yolculuğu",
      "Talep analizi ve marka gizleme",
      "AI yardım: günde 50 soru",
      "WhatsApp: ayda 1.000 mesaj",
    ],
  },
  {
    code: "plus",
    ...
    features: [
      ...
      "Çift taraflı WhatsApp bağlantısı",
      "AI yardım: günde 200 soru",
      "WhatsApp: ayda 5.000 mesaj",
    ],
  },
];
export function RecurringPlans({ tenantId, beforeCheckout, initialPlan }: any) {
  const [data, setData] = useState<any>(null),
    ...
    [cardAccepted, setCardAccepted] = useState(false),
    ...
    <section className="recurring-section">
      ...
      {sub && (
        <section className="panel margin-top">
          ...
          {data.payment_method?.stored ? (
            <p className="notice">
              <CreditCard size={17} />
              Abonelik kartınız iyzico’nun güvenli altyapısında kayıtlıdır. Neta
          ...
          onSubmit={async (e) => {
            ...
            try {
              ...
              const r = await api("recurring", {
                ...
                card_storage_accepted: cardAccepted,
                ...form,
              });
              setHtml(r.form);
        ...
        >
          ...
          <div className="notice">
            ...
            <span>
              ...
              veri işleme amaçlarını ve haklarınızı açıklar; bu bildirim açık
              rıza talebi değildir.
            </span>
          </div>
          <label className="consent-row">
            ...
            <span>
              ...
              kabul ediyorum. {money(checkoutPlan?.amount || 0)} tutarın her ay
              otomatik tahsil edilmesini onaylıyorum.
            </span>
          </label>
          <label className="consent-row">
            <Checkbox
              checked={cardAccepted}
              onCheckedChange={(v) => setCardAccepted(v === true)}
            />
            <span>
              Kartımın aylık yenilemeler için iyzico’nun güvenli altyapısında
              saklanmasını kabul ediyorum. Kart numarası ve CVC Neta’ya
              aktarılmaz.
            </span>
          </label>
          ...
          <button
            ...
            disabled={!accepted || !cardAccepted || busy}
          >
